...
<div class="flex min-h-[90vh] w-[500px] flex-col justify-center px-6 py-12 lg:px-8 rounded-2xl bg-white">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div>
                <button onclick="window.location.href='/'" type="submit" class="flex w-full justify-center rounded-md bg-[#37385b] px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-[#4d4e75] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Daftar</button>
            </div>
            </form>

            <p class="mt-10 text-center text-sm text-gray-500">
            Sudah punya akun?
            <a href="/" class="font-semibold leading-6 text-[#37385b] hover:text-[#4d4e75]">Masuk</a>
            </p>
        </div>
</div>
@endsection